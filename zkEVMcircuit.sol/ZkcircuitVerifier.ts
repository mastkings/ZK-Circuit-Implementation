...
export interface ZkcircuitVerifierInterface extends utils.Interface {
  functions: {
...
export interface ZkcircuitVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZkcircuitVerifierInterface;
